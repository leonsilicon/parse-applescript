-- https://github.com/KAYLukas/applescript-json/blob/master/json.applescript
...
on encodeString(value)
	-- Large string manipulations are slow in AppleScript
	if (count of value) is 256 then
		set s to "import json, sys, codecs" & return
		set s to s & "sys.stdin = codecs.getreader('utf8')(sys.stdin)" & return
